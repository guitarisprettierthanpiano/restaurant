        ...
        <div className="cocktails">
          ...
          <div className="cocktails-left">
            <div className="cocktails-left-item">
              <h4>Aloha Punch</h4>
              <p>
                Light rum, pineapple rum and coconut rum with pineapple &
                cranberry juice topped with fresh coconut flakes and a fresh rum
                soaked pineapple
              </p>
            </div>
            <div className="cocktails-left-item">
              ...
              <p>
                Smirnoff Blueberry vodka with lemonade and splash of club soda,
                blueberry syrup and booze soaked blueberries
              </p>
            </div>
            <div className="cocktails-left-item">
              <h4>Quarantini</h4>
              <p>
                Malibu rum, blue curacao and pineapple juice topped with fresh
                rum soaked pineapples
              </p>
            </div>
          </div>
          ...
          <div className="cocktails-right">
            <div className="cocktails-right-item">
              <h4>Maui Mai Tai</h4>
              <p>
                Bacardi gold rum, lime juice, orgeat, orange curacao, simple
                syrup, served with fresh orange & cherry
              </p>
            </div>
            <div className="cocktails-right-item">
              <h4>Hula Punch</h4>
              <p>
                Captain Morgan spiced and pineapple rums, peach schnapps,
                cranberry and pineapple juices garnished with fresh boozy
                pineapple chunks and cherry
              </p>
            </div>
            <div className="cocktails-right-item">
